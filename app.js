...
var fs = require('fs')
var logger = fs.createWriteStream('report-PaolaProssi18.txt', {
...
function BOMBA(tweet) {
	...
	if ( tweet.user.screen_name !== 'PaolaProssi18' ) {
...
var stream = T.stream('statuses/filter', { follow:  ( '778747478384312321 , 899904255317778432 , 957024331376275456 , 967887269104320512 , 978960131638644736 , 948468159073234944, 948895169759211521 , 955435252083843072 , 928410762380529664 , 934374469698588673 , 912476913318346753 , 956678839563931648 , 900442763598192641 , 914254996182532096 , 928665122645692416 , 960648946271039488 , 927929016111325188 , 910869642368966657 , 930801214182260737 , 962547978803302400 , 837568377749180416 , 955765875428163584 , 950165227731017729 ' ) });
